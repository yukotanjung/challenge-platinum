...
describe('Items', () => {
  ...
  it('POST /items/add-item/ => create a new item', () => {
    return (
      createLoginToken(app, { username: 'yukotanjung', password: '12345' }, function(header) {
        request(app)
        .post('/items/add-item/')
  ...
  it('POST /items/add-item/ => item name correct data type check', () => {
    return createLoginToken(app, { username: 'yukotanjung', password: '12345' }, function(header) {
